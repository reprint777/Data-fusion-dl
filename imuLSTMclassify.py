...
from LSTM_utils import train_loop, test_loop
...
for i in filenameList:
    ...
    df.replace(['hw', 'ft', 'di'], 'related', inplace=True)
...
model = nn.LSTM(input_size=6, hidden_size=Hidden_size, num_layers=Num_layers, batch_first=True)
